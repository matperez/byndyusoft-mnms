const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DatePicker-ClD6BdHg.js","assets/jsx-runtime-ConiGv8a.js","assets/DatePicker-jAr1bsDA.css","assets/QuantityInput--vyWjfIY.js","assets/QuantityInput-C_OCn0QU.css"])))=>i.map(i=>d[i]);
...
const _Users_angolovin_src_github_com_matperez_byndyusoft_mnms_src_components_date_picker_DatePicker_DatePicker = () => __vitePreload(() => import('./DatePicker-ClD6BdHg.js'),true              ?__vite__mapDeps([0,1,2]):void 0).then((mod) => mod.DatePicker);
const _Users_angolovin_src_github_com_matperez_byndyusoft_mnms_src_components_quantity_input_QuantityInput_QuantityInput = () => __vitePreload(() => import('./QuantityInput--vyWjfIY.js'),true              ?__vite__mapDeps([3,1,4]):void 0).then((mod) => mod.QuantityInput);
__pwRegistry.initialize({ _Users_angolovin_src_github_com_matperez_byndyusoft_mnms_src_components_date_picker_DatePicker_DatePicker,
  _Users_angolovin_src_github_com_matperez_byndyusoft_mnms_src_components_quantity_input_QuantityInput_QuantityInput });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-C0njtHQA.js.map
